...
public class W2Job extends Job{
    ...
    public W2Job(
        ...
        this.patientsPerHour=patientsPerWeek/weeklyHours;
...
//        this.normalizedAnnualComp= (annualSalaryAndBonus +healthInsuranceValue+otherBenefitsValue+paidDaysOffValue);
        this.normalizedAnnualComp= (annualSalaryAndBonus +healthInsuranceValue+retirementBenefitsValue+otherBenefitsValue+paidDaysOffValue);
